...
export const operationsDistributionFields: FieldConfig[] = [
  ...
  {
    key: "articleAccessoire",
    label: "Article vendu",
    type: "select",
    showIf: (v) => v.typeOperation === "VENTE_ACCESSOIRES",
    staticOptions: [
  ...
  {
    key: "montantCreditation",
    label: "Montant",
    type: "number",
    defaultValue: 0,
    showIf: (v) => v.typeOperation !== "APPROVISIONNEMENT",
  },
  {
    key: "montantApprovisionnement",
    label: "Montant approvisionnement",
    type: "number",
    defaultValue: 0,
    showIf: (v) => v.typeOperation === "APPROVISIONNEMENT",
  },
